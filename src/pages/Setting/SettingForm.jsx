...
function SettingForm() {
  ...
  return (
    <main className="w-full h-full space-y-5">
      <div className="card-user-infor w-full h-[120px] bg-secondary p-5 rounded-5 rounded-[20px] flex items-center justify-between">
