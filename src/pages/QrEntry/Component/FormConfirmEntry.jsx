  ...
  return (
    <>
      <div className="flex-1 flex flex-col confirmForm w-full h-fit bg-secondary rounded-[20px] p-5 overflow-auto scrollbar-hide">
          ...
          <div className="flex-1 headConfirmForm text-accent h-[46px] flex justify-between">
            <p className="font-bold">
              ...
              <span className="text-blue-400">
                {stuEntryInfor.studentId === 0
                  ? "N/A"
                  : stuEntryInfor.studentId}
              </span>
            </p>
          </div>
        ...
        <div className="check-purpose text-accent mt-5">
          ...
          <div className="container-check-purpose grid lg:grid-cols-2 xl:grid-cols-3 gap-5 pt-5">
            <div className="check-purpose flex items-center space-x-2 -info">
              ...
              />
              <label htmlFor="Read_Book" className="label-text text-[#32E2FF]">
                Reading
              </label>
            </div>
            <div className="check-purpose flex items-center space-x-2 -info z-20">
              ...
              />
              <label htmlFor="Assignment" className="label-text text-[#32E2FF]">
                Assignment
              </label>
            </div>
            <div className="check-purpose flex items-center space-x-2 -info">
        ...
        <div
          className="flex-1 container-button h-full items-end mt-5 grid grid-cols-2 gap-2"
          data-tip="Check this box if your task falls under any other purpose not listed above."
        >
          <button
            className="btn btn-primary hover:border-white"
            onClick={handleSaveEntry}
          >
            Entry
          </button>
          <button
            className="btn btn-outline border-blue-400 text-accent"
