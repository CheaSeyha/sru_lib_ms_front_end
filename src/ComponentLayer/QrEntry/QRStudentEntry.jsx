...
function QRStudentEntry() {
    ...
    return (
        <ScanResultIDProvider>
            <div className='w-full h-fit sm:h-full flex flex-col-reverse sm:flex-row space-x-5 overflow-auto'>
                <div className="flex flex-col space-y-5 ScanQR-ConfirmForm w-[150px] sm:w-[230px] lg:w-[290px] xl:w-[390px] rounded-[20px]">
                    {/* <!-- Show Scan Camera  --> */}
                    <CameraScanQR />
                    {/* <!-- Form Show Student info after scan  --> */}
                    <FormConfirmEntry />
                </div>
                <div className="flex-1 sm:flex flex-col data-of-entry-table w-full h-full sm:space-y-5 overflow-auto">
                    <div className="student-entry-card w-full h-[104px] grid grid-cols-3 sm:gap-5">
