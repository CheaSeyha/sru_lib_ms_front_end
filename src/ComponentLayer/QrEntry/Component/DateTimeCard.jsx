...
const DateTimeCard = () => {
    ...
    return (
        <div className="date-time-card drop-shadow-xl w-fit flex justify-center items-center px-5 rounded-[10px] h-full bg-gradient-to-r from-[#00D1FF] to-[#E7FBFF] text-black space-x-2">
            <Timer />
