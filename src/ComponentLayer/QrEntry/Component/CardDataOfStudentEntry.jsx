...
function CardDataOfStudentEntry({ bgIcon, bgColor, iconCard, cardType, cardTypeDetail, amountData }) {
    return (
        <>
            <div className={`container-card-data cursor-pointer drop-shadow-md hover:scale-105 transition-all ease-in-out w-full xl:h-[104px] flex rounded-[20px] bg-gradient-to-r ${bgColor} p-5`}>
