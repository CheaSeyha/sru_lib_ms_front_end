...
function HeadTextForTableData() {
    ...
    return (
        <>
            <div className="flex flex-col table-container w-full space-y-5 h-full bg-secondary rounded-[20px] p-5 text-accent overflow-auto">
                ...
                <div className="flex-1 w-full h-full overflow-y-auto grid items-end overscroll-auto">
                            ...
                            <tbody>
                                ...
                                {fakeDataStudent.map((e, index) => (
                                    <tr key={index} className='hover:bg-primary'>
                                        ...
                                        <td>{e.exitTimes}</td>
                                        <td>{e.activity}</td>
                                        <td><span className={`w-fit h-fit px-3 rounded-lg ${e.status ? 'bg-blue-600' : 'bg-red-600'} bg-blue-600`}>{e.status ? "IN" : "OUT"}</span></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
