...
const useCRUDStaff = () => {
    ...
    }, [getAllStaff]); // Dependency on getAllStaff to ensure the staff list is updated after save
    ...
    }, [getAllStaff]); // Dependency on getAllStaff to ensure the staff list is updated after deletion

    // Function to update staff data
    const updateStaff = useCallback(async (staffID, updatedData) => {
        setLoading(true);
        setError(null);
        setSuccess(false);
    ...
    }, [getAllStaff]); // Dependency on getAllStaff to ensure the staff list is updated after update
    ...
    return { saveStaff, deleteStaff, updateStaff, getAllStaff, loading, error, success, staffList };
};
