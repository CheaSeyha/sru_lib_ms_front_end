...
function LoginForm() {
    ...
    const handleLoginSubmit = async (e) => {
        e.preventDefault();
        try {
            await login(loginEmail, loginPassword, rememberMe); // Pass "Remember Me" state
            toast.success("Login Success");
            navigate('/'); // Redirect after login
        } catch (error) {
            console.error('Login failed:', error);
                                ...
                                <div className="form-container">
                                    ...
                                    <div className="login text-start grid gap-2">
                                        ...
                                        <div className="create-acc-rememberMe flex justify-between">
                                            ...
                                            <button type="button" onClick={() => setIsForgotPassword(true)} className='text-blue-500'>Forget Password?</button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full mt-5">
                                        <button type="button" onClick={() => setIsLogin(false)} className='text-accent'>Don't have an account? <b>Register</b></button>
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="">
                                    ...
                                    <div className="login text-start grid gap-2">
                                        ...
                                        <div className=" w-full flex justify-end">
                                            <button type="button" onClick={() => setIsLogin(true)} className='text-blue-500 '>Already have an account</button>
                                        </div>
                                    </div>
                            ...
                            {isForgotPassword && (
                                <div className="">
                                    ...
                                    <div className="w-full mt-3">
                                        <button type="button" onClick={handleBackToLoign} className='text-accent'>Back to login</button>
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="">
                                    ...
                                    <div className="text-start grid gap-2">
                                        ...
                                        <div className="relative w-full h-[46px] flex items-center">
                                            ...
                                            />
                                            <label className="swap absolute right-2 top-1/2 transform -translate-y-1/2 cursor-pointer">
                                                <input id='hidePW1' type="checkbox" onChange={handleHidePW} className="hidden" />
                                                <Eye className="swap-on h-5 w-5 text-gray-500" />
                                                <EyeOff className="swap-off h-5 w-5 text-gray-500" />
                                            </label>
                                        </div>
                                        ...
                                        <div className="relative w-full h-[46px] flex items-center">
                                            ...
                                            />
                                            <label className="swap absolute right-2 top-1/2 transform -translate-y-1/2 cursor-pointer">
                                                <input id='hidePW2' type="checkbox" onChange={handleHidePW} className="hidden" />
                                                <Eye className="swap-on h-5 w-5 text-gray-500" />
                                                <EyeOff className="swap-off h-5 w-5 text-gray-500" />
                                            </label>
                                        </div>
